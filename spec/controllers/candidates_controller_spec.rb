  ...
  describe 'PATCH #update' do
    ...
    context 'with invalid attributes' do
      ...
      it 'does not update the new candidate' do
        ...
        expect(flash[:error]).to eq("Name can't be blank, Email can't be blank, Email is invalid, Cgpa can't be blank, Personal interest can't be blank, and Contact is not a number")
      end
